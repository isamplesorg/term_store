...
class TermRepository:
    ...
    def add(self, item: Term) -> str:
        """
        Adds a term to the store.

        Note this will raise a DatabaseIntegrityError if the URI
    ...
    def broader(self, start_uri: str) -> typing.Iterator[Term]:
    ...
    def schemes(self) -> typing.Iterator[typing.Tuple[str, int]]:
        sql = sqlalchemy.text(
